  ...
  <Transition name="fade">
    ...
    >
      ...
      >
        <!-- Background Pattern -->
        <div
          class="absolute inset-0 opacity-[0.03] bg-[url('/grain.png')] bg-repeat pointer-events-none"
        ></div>

        <div class="relative z-10 flex flex-col items-center">
          <div
            class="w-24 h-24 bg-brand-red border-4 border-stone-900 shadow-brutal flex items-center justify-center mb-8 rotate-3"
          >
          ...
          <h2
            class="text-2xl md:text-3xl font-display font-black text-stone-900 uppercase tracking-wide mb-3"
          >
