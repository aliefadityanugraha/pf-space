...
async function saveUserRole(userId) {
  ...
  try {
    ...
    showToast(
      `Peran pengguna diperbarui menjadi ${newRoleName || "role baru"}`,
    );
  } catch (err) {
...
<template>
  <div class="p-4 md:p-8">
    ...
    <div
      v-else-if="error"
      class="bg-red-50 border-2 border-red-300 p-6 text-center"
    >
    ...
    <template v-else>
      ...
      <section class="mb-8">
        <h2
          class="text-lg font-bold uppercase tracking-wider mb-4 flex items-center gap-2"
        >
