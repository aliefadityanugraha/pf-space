...
<template>
  <div class="p-4 md:p-8">
    ...
    <nav class="flex items-center gap-2 text-xs font-mono uppercase tracking-wider mb-4">
      ...
      <span class="text-stone-400">/</span>
      <Badge variant="outline" class="bg-stone-100 dark:bg-stone-800 text-stone-800 dark:text-stone-200 border-2 border-black dark:border-stone-100 font-bold">Pengaturan</Badge>
    </nav>
