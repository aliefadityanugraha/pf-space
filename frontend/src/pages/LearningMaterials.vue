      ...
      <div class="max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-24 relative">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 class="text-3xl md:text-7xl font-display font-black text-stone-900 leading-none mb-4 md:mb-6">
              Materi <span class="text-brand-teal italic underline md:decoration-4 underline-offset-8">Terbuka</span> Pembelajaran
            </h1>
