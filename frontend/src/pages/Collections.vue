          ...
          <CardContent class="p-0">
            ...
            >
              ...
              <div class="absolute top-2 left-2 md:top-3 md:left-3">
                <Badge
                  class="bg-brand-red text-white border-2 border-black shadow-brutal-xs text-[10px] md:text-xs"
                >
            ...
            <div class="p-4 md:p-5">
              <div class="flex justify-between items-start gap-2 mb-2">
                ...
                <span
                  class="text-[10px] md:text-xs font-mono font-bold text-stone-400"
                  >{{ item.film?.tahun_karya }}</span
                >
              </div>
              ...
              <div class="flex items-center gap-2">
                ...
                >
                  <Loader2
                    v-if="removingIds.has(item.film_id)"
