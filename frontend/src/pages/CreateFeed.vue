  ...
  meta: [
    {
      name: "description",
      content:
        "Bagikan perkembangan produksi film Anda ke feed produksi PF Space.",
    },
  ...
  <PageLayout>
    <div class="max-w-7xl mx-auto px-4 md:px-8 mt-4 md:mt-10 mb-16">
      ...
      >
        <template #extra>
          <span
            class="mt-3 inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-stone-400"
          >
