  ...
  meta: [
    {
      name: "description",
      content:
        "Panduan dan etika berinteraksi serta mengunggah karya di platform PF Space.",
    },
  ],
});
</script>
      ...
      <div class="mt-6 md:mt-8 space-y-6 md:space-y-8 mb-16 font-body">
            ...
            <div class="flex items-start gap-3 md:gap-4">
              ...
              <div class="min-w-0">
                ...
                <p class="text-sm md:text-base text-stone-600 leading-relaxed">
                  ...
                  pembelajaran bagi siswa SMK di seluruh Indonesia.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        >
          ...
          <div class="text-xs md:text-sm text-stone-700">
            ...
            yang melanggar pedoman ini demi menjaga kenyamanan lingkungan
            belajar bersama.
          </div>
        </div>
      </div>
